...
py -3.12 -c "import tkinter, venv" 2>nul
if not errorlevel 1 (
    set "PYTHON_CMD=py -3.12"
    goto :found_python
)

py -3 -c "import tkinter, venv" 2>nul
if not errorlevel 1 (
    set "PYTHON_CMD=py -3"
    goto :found_python
)

python -c "import tkinter, venv" 2>nul
if not errorlevel 1 (
...
if exist "C:\Python312\python.exe" (
    "C:\Python312\python.exe" -c "import tkinter, venv" 2>nul
    if not errorlevel 1 (
...
if exist "C:\Python311\python.exe" (
    "C:\Python311\python.exe" -c "import tkinter, venv" 2>nul
    if not errorlevel 1 (
...
if exist "C:\Python310\python.exe" (
    "C:\Python310\python.exe" -c "import tkinter, venv" 2>nul
    if not errorlevel 1 (
